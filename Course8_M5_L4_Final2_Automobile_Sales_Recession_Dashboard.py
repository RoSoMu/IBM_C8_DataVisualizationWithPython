...
def update_input_container(selected_stat):
    return False if selected_stat == "Yearly Statistics" else True
...
def update_output_container(selected_stat, input_year):
    ...
    # Hint:Use Vehicle_Type and Advertising_Expenditure columns
        ...
        R_chart3 = dcc.Graph(
            figure=px.pie(exp_rec,
                ...
                names = "Vehicle_Type",
                title = "Total Adevertising Expenditure Share by Vehicle Type over Recession Period"))
...
# TASK 2.6: Create and display graphs for Yearly Report Statistics
 # Yearly Statistic Report Plots
    ...
    elif (input_year and selected_stat =='Yearly Statistics') :
